...
public class knife extends SacrificialDagger
{
    public knife()
    {
        super();
    ...
    public void registerIcons(IIconRegister iconRegister)
    {
         ...
         } else this.itemIcon = iconRegister.registerIcon("arcanearteries:knife");
...
//        }
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
    {
        ...
        {
            findAndFillAltar(world, player, 100);
        } else
        {
            findAndFillAltar(world, player, 1000);
        }

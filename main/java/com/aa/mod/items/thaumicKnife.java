...
public class thaumicKnife extends SacrificialDagger
{
    public thaumicKnife()
    {
        super();
        ...
        setFull3D();
        this.setUnlocalizedName("thaumicKnife");
    ...
    public void registerIcons(IIconRegister iconRegister)
    {
         ...
         {
             this.itemIcon = iconRegister.registerIcon("arcanearteries:thaumicOrb");
         } else  this.itemIcon = iconRegister.registerIcon("arcanearteries:thaumicKnife");
    ...
    {
            par3List.add("Some would say I am crazy for using this!");
    }
